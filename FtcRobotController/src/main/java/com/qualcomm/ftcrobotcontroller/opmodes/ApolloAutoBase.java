 ...
 */
public class ApolloAutoBase extends LinearOpMode {
...
// TurnToHeading(navXPIDController.PIDResult yawPIDResult, float heading, double maxTimeSeconds)
        ...
        try {
            ...
            StopDriving();
            Log.w("AutoLog", "3");
            TurnToHeading(yawPIDResult, (float) 180., (double) 3.);
            StopDriving();
            Log.w("AutoLog", "4");
            sleep(2000);
            heading = 180;
            ...
            StopDriving();
            Log.w("AutoLog", "5");
            TurnToHeading(yawPIDResult, (float) -90., (double) 3.);
            StopDriving();
            Log.w("AutoLog", "6");
            sleep(2000);
            heading = -90;
            ...
            StopDriving();
            Log.w("AutoLog", "7");
            TurnToHeading(yawPIDResult, (float) 0., (double) 3.);
            StopDriving();
            Log.w("AutoLog", "8");
            sleep(2000);
            DriveOnHeading(yawPIDResult, heading, distanceInches);
